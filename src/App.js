...
import { MerchantPayments } from './routes/merchantPayments'
...
import NetworkHome from './routes/networks/network';
import BscHome from './routes/networks/bsc-home'
import CronosHome from './routes/networks/cronos-home'
import BscPaymentContract from './routes/networks/bsc-payment-contract'
import CronosPaymentContract from './routes/networks/cronos-payment-contract'
import {BscStableCoins} from './routes/networks/bsc-stable-coins'
import CronosStableCoins from './routes/networks/cronos-stable-coins'
...
let routes = [
  ...
  { title: "Merchant Payments", to: "/merchants/:id/payments", allowed: ['basicEmployee', 'csaEmployee'], excludeFromMenu: true },
  ...
  { title: "Networks", to: "/networks/bsc/payment-contract", allowed: ['admin'] },
  { title: "BSC Payment Contract", to: "/networks/bsc/payment-contract", allowed: ['admin'], excludeFromMenu: true },
  { title: "BSC Stable Coins", to: "/networks/bsc/stable-coins", allowed: ['admin'], excludeFromMenu: true },
  { title: "Cronos Payment Contract", to: "/networks/cronos/payment-contract", allowed: ['admin'], excludeFromMenu: true },
  { title: "Cronos Stable Coins", to: "/networks/cronos/stable-coins", allowed: ['admin'], excludeFromMenu: true },
            ...
            <div className="bg-gray-100 min-h-screen pt-2 overflow-visible">
              ...
              <Routes>
                ...
                <Route path="/merchants" element={<RequireAuth><MerchantsHome /></RequireAuth>}>
                  ...
                  <Route path=":id/payments" element={<RequireAuth><MerchantPayments /></RequireAuth>} />
                ...
                <Route path="/networks" element={<RequireAuth><NetworkHome /></RequireAuth>}>
                  <Route path="bsc" element={<RequireAuth><BscHome /></RequireAuth>} >
                    <Route index element={<RequireAuth><BscPaymentContract /></RequireAuth>} />
                    <Route path="payment-contract" element={<RequireAuth><BscPaymentContract /></RequireAuth>} />
                    <Route path="stable-coins" element={<RequireAuth><BscStableCoins /></RequireAuth>} />
                  </Route>
                  <Route path="cronos" element={<RequireAuth><CronosHome /></RequireAuth>} >
                    <Route index element={<RequireAuth><CronosPaymentContract /></RequireAuth>} />
                    <Route path="payment-contract" element={<RequireAuth><CronosPaymentContract /></RequireAuth>} />
                    <Route path="stable-coins" element={<RequireAuth><CronosStableCoins /></RequireAuth>} />
                  </Route>
                </Route>
              </Routes>
            </div>
